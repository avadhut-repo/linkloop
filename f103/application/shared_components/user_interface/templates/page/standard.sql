...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(8705026657851539)
,p_theme_id=>42
,p_name=>'Standard'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8705367893851540)
,p_page_template_id=>wwv_flow_imp.id(8705026657851539)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8705635058851540)
,p_page_template_id=>wwv_flow_imp.id(8705026657851539)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8705903002851540)
,p_page_template_id=>wwv_flow_imp.id(8705026657851539)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8706255842851540)
,p_page_template_id=>wwv_flow_imp.id(8705026657851539)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8706575972851540)
,p_page_template_id=>wwv_flow_imp.id(8705026657851539)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8706896162851540)
,p_page_template_id=>wwv_flow_imp.id(8705026657851539)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8707158243851540)
,p_page_template_id=>wwv_flow_imp.id(8705026657851539)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8707470744851540)
,p_page_template_id=>wwv_flow_imp.id(8705026657851539)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8707709493851542)
,p_page_template_id=>wwv_flow_imp.id(8705026657851539)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8708054351851542)
,p_page_template_id=>wwv_flow_imp.id(8705026657851539)
