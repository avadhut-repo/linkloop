...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(8690226809851526)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8690549252851528)
,p_page_template_id=>wwv_flow_imp.id(8690226809851526)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8690866178851528)
,p_page_template_id=>wwv_flow_imp.id(8690226809851526)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8691117415851528)
,p_page_template_id=>wwv_flow_imp.id(8690226809851526)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8691445422851528)
,p_page_template_id=>wwv_flow_imp.id(8690226809851526)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8691782498851528)
,p_page_template_id=>wwv_flow_imp.id(8690226809851526)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8692072675851528)
,p_page_template_id=>wwv_flow_imp.id(8690226809851526)
,p_name=>'Left Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8692375765851528)
,p_page_template_id=>wwv_flow_imp.id(8690226809851526)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8692637349851528)
,p_page_template_id=>wwv_flow_imp.id(8690226809851526)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8692988921851529)
,p_page_template_id=>wwv_flow_imp.id(8690226809851526)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8693222567851529)
,p_page_template_id=>wwv_flow_imp.id(8690226809851526)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8693560836851529)
,p_page_template_id=>wwv_flow_imp.id(8690226809851526)
