...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(8686127427851523)
,p_theme_id=>42
,p_name=>'Login'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8686457663851523)
,p_page_template_id=>wwv_flow_imp.id(8686127427851523)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8686760293851523)
,p_page_template_id=>wwv_flow_imp.id(8686127427851523)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8687055943851525)
,p_page_template_id=>wwv_flow_imp.id(8686127427851523)
,p_name=>'Body Header'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8687332107851525)
,p_page_template_id=>wwv_flow_imp.id(8686127427851523)
,p_name=>'Body Footer'
