...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(8693924629851529)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8694263522851531)
,p_page_template_id=>wwv_flow_imp.id(8693924629851529)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8694563713851531)
,p_page_template_id=>wwv_flow_imp.id(8693924629851529)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8694824133851531)
,p_page_template_id=>wwv_flow_imp.id(8693924629851529)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8695139920851531)
,p_page_template_id=>wwv_flow_imp.id(8693924629851529)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8695479629851531)
,p_page_template_id=>wwv_flow_imp.id(8693924629851529)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8695729093851531)
,p_page_template_id=>wwv_flow_imp.id(8693924629851529)
,p_name=>'Right Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8696080730851531)
,p_page_template_id=>wwv_flow_imp.id(8693924629851529)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8696342553851531)
,p_page_template_id=>wwv_flow_imp.id(8693924629851529)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8696687790851532)
,p_page_template_id=>wwv_flow_imp.id(8693924629851529)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8696945203851532)
,p_page_template_id=>wwv_flow_imp.id(8693924629851529)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8697235105851532)
,p_page_template_id=>wwv_flow_imp.id(8693924629851529)
