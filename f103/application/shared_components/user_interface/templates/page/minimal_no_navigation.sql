...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(8701603433851535)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8701992381851537)
,p_page_template_id=>wwv_flow_imp.id(8701603433851535)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8702231829851537)
,p_page_template_id=>wwv_flow_imp.id(8701603433851535)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8702556131851537)
,p_page_template_id=>wwv_flow_imp.id(8701603433851535)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8702833061851537)
,p_page_template_id=>wwv_flow_imp.id(8701603433851535)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8703105042851537)
,p_page_template_id=>wwv_flow_imp.id(8701603433851535)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8703408621851537)
,p_page_template_id=>wwv_flow_imp.id(8701603433851535)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8703797121851537)
,p_page_template_id=>wwv_flow_imp.id(8701603433851535)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8704007628851537)
,p_page_template_id=>wwv_flow_imp.id(8701603433851535)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8704319721851539)
,p_page_template_id=>wwv_flow_imp.id(8701603433851535)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8704655267851539)
,p_page_template_id=>wwv_flow_imp.id(8701603433851535)
