...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(8680605999851518)
,p_theme_id=>42
,p_name=>'Marquee'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8680939917851518)
,p_page_template_id=>wwv_flow_imp.id(8680605999851518)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8681247073851518)
,p_page_template_id=>wwv_flow_imp.id(8680605999851518)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8681599420851518)
,p_page_template_id=>wwv_flow_imp.id(8680605999851518)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8681878458851520)
,p_page_template_id=>wwv_flow_imp.id(8680605999851518)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8682159102851520)
,p_page_template_id=>wwv_flow_imp.id(8680605999851518)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8682454658851520)
,p_page_template_id=>wwv_flow_imp.id(8680605999851518)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8682748681851520)
,p_page_template_id=>wwv_flow_imp.id(8680605999851518)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8683016655851520)
,p_page_template_id=>wwv_flow_imp.id(8680605999851518)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8683326313851520)
,p_page_template_id=>wwv_flow_imp.id(8680605999851518)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8683658019851520)
,p_page_template_id=>wwv_flow_imp.id(8680605999851518)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8683944876851521)
,p_page_template_id=>wwv_flow_imp.id(8680605999851518)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8684271877851521)
,p_page_template_id=>wwv_flow_imp.id(8680605999851518)
