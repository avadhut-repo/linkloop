...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8776954706851610)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8777214294851610)
,p_plug_template_id=>wwv_flow_imp.id(8776954706851610)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8777530307851610)
,p_plug_template_id=>wwv_flow_imp.id(8776954706851610)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8777845914851610)
,p_plug_template_id=>wwv_flow_imp.id(8776954706851610)
,p_name=>'Sub Regions'
