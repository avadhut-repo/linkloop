...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8715014631851550)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8715381312851551)
,p_plug_template_id=>wwv_flow_imp.id(8715014631851550)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8715669631851551)
,p_plug_template_id=>wwv_flow_imp.id(8715014631851550)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8715933444851551)
,p_plug_template_id=>wwv_flow_imp.id(8715014631851550)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8716213459851551)
,p_plug_template_id=>wwv_flow_imp.id(8715014631851550)
,p_name=>'Sub Regions'
