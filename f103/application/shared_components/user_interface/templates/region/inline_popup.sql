...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8764483221851596)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8764789092851596)
,p_plug_template_id=>wwv_flow_imp.id(8764483221851596)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8765077765851596)
,p_plug_template_id=>wwv_flow_imp.id(8764483221851596)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8765320765851596)
,p_plug_template_id=>wwv_flow_imp.id(8764483221851596)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8765677689851596)
,p_plug_template_id=>wwv_flow_imp.id(8764483221851596)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8765916845851596)
,p_plug_template_id=>wwv_flow_imp.id(8764483221851596)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8766225975851598)
,p_plug_template_id=>wwv_flow_imp.id(8764483221851596)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8766587734851598)
,p_plug_template_id=>wwv_flow_imp.id(8764483221851596)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8766823699851598)
,p_plug_template_id=>wwv_flow_imp.id(8764483221851596)
,p_name=>'Sub Regions'
