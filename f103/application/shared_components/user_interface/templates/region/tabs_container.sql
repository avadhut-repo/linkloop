...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8789444508851626)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8789789011851628)
,p_plug_template_id=>wwv_flow_imp.id(8789444508851626)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8790010215851628)
,p_plug_template_id=>wwv_flow_imp.id(8789444508851626)
,p_name=>'Tabs'
