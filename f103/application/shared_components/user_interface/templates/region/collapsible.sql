...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8732514855851567)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8732896139851567)
,p_plug_template_id=>wwv_flow_imp.id(8732514855851567)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8733185351851567)
,p_plug_template_id=>wwv_flow_imp.id(8732514855851567)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8733412020851567)
,p_plug_template_id=>wwv_flow_imp.id(8732514855851567)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8733759309851567)
,p_plug_template_id=>wwv_flow_imp.id(8732514855851567)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8734061077851567)
,p_plug_template_id=>wwv_flow_imp.id(8732514855851567)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8734304990851568)
,p_plug_template_id=>wwv_flow_imp.id(8732514855851567)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8734659716851568)
,p_plug_template_id=>wwv_flow_imp.id(8732514855851567)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8734924723851568)
,p_plug_template_id=>wwv_flow_imp.id(8732514855851567)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8735294739851568)
,p_plug_template_id=>wwv_flow_imp.id(8732514855851567)
,p_name=>'Sub Regions'
