...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8774462482851606)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8774703325851606)
,p_plug_template_id=>wwv_flow_imp.id(8774462482851606)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8775059382851607)
,p_plug_template_id=>wwv_flow_imp.id(8774462482851606)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8775364052851607)
,p_plug_template_id=>wwv_flow_imp.id(8774462482851606)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8775675530851607)
,p_plug_template_id=>wwv_flow_imp.id(8774462482851606)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8775928627851607)
,p_plug_template_id=>wwv_flow_imp.id(8774462482851606)
,p_name=>'Sub Regions'
