...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8720775986851556)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8721099179851557)
,p_plug_template_id=>wwv_flow_imp.id(8720775986851556)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8721338258851557)
,p_plug_template_id=>wwv_flow_imp.id(8720775986851556)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8721676459851557)
,p_plug_template_id=>wwv_flow_imp.id(8720775986851556)
,p_name=>'Sub Regions'
