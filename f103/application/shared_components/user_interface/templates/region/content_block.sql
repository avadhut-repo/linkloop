...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8742016496851575)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8742313005851575)
,p_plug_template_id=>wwv_flow_imp.id(8742016496851575)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8742622807851575)
,p_plug_template_id=>wwv_flow_imp.id(8742016496851575)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8742931397851576)
,p_plug_template_id=>wwv_flow_imp.id(8742016496851575)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8743299359851576)
,p_plug_template_id=>wwv_flow_imp.id(8742016496851575)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8743598141851576)
,p_plug_template_id=>wwv_flow_imp.id(8742016496851575)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8743827921851576)
,p_plug_template_id=>wwv_flow_imp.id(8742016496851575)
,p_name=>'Sub Regions'
