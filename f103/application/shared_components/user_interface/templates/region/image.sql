...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8749860229851582)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8750144380851582)
,p_plug_template_id=>wwv_flow_imp.id(8749860229851582)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8750493172851584)
,p_plug_template_id=>wwv_flow_imp.id(8749860229851582)
,p_name=>'Sub Regions'
