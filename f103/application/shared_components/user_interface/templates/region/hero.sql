...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8746637871851579)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8746900696851579)
,p_plug_template_id=>wwv_flow_imp.id(8746637871851579)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8747261091851581)
,p_plug_template_id=>wwv_flow_imp.id(8746637871851579)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8747583194851581)
,p_plug_template_id=>wwv_flow_imp.id(8746637871851579)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8747876199851581)
,p_plug_template_id=>wwv_flow_imp.id(8746637871851579)
,p_name=>'Sub Regions'
