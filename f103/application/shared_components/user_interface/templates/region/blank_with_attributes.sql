...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8713627418851548)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8713968104851548)
,p_plug_template_id=>wwv_flow_imp.id(8713627418851548)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8714238516851550)
,p_plug_template_id=>wwv_flow_imp.id(8713627418851548)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8714523930851550)
,p_plug_template_id=>wwv_flow_imp.id(8713627418851548)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8714897726851550)
,p_plug_template_id=>wwv_flow_imp.id(8713627418851548)
,p_name=>'Sub Regions'
