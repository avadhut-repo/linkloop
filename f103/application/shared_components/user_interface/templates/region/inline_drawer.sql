...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8759833796851592)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8760136386851592)
,p_plug_template_id=>wwv_flow_imp.id(8759833796851592)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8760432742851593)
,p_plug_template_id=>wwv_flow_imp.id(8759833796851592)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8760752488851593)
,p_plug_template_id=>wwv_flow_imp.id(8759833796851592)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8761023767851593)
,p_plug_template_id=>wwv_flow_imp.id(8759833796851592)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8761360329851593)
,p_plug_template_id=>wwv_flow_imp.id(8759833796851592)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8761646086851593)
,p_plug_template_id=>wwv_flow_imp.id(8759833796851592)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8761925387851593)
,p_plug_template_id=>wwv_flow_imp.id(8759833796851592)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8762201227851593)
,p_plug_template_id=>wwv_flow_imp.id(8759833796851592)
,p_name=>'Sub Regions'
