...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8755223009851587)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8755577882851589)
,p_plug_template_id=>wwv_flow_imp.id(8755223009851587)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8755839360851589)
,p_plug_template_id=>wwv_flow_imp.id(8755223009851587)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8756141429851589)
,p_plug_template_id=>wwv_flow_imp.id(8755223009851587)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8756402412851589)
,p_plug_template_id=>wwv_flow_imp.id(8755223009851587)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8756728819851589)
,p_plug_template_id=>wwv_flow_imp.id(8755223009851587)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8757024630851590)
,p_plug_template_id=>wwv_flow_imp.id(8755223009851587)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8757338576851590)
,p_plug_template_id=>wwv_flow_imp.id(8755223009851587)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8757649102851590)
,p_plug_template_id=>wwv_flow_imp.id(8755223009851587)
,p_name=>'Sub Regions'
