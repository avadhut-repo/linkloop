...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8796832293851637)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8797190053851637)
,p_plug_template_id=>wwv_flow_imp.id(8796832293851637)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8797411054851639)
,p_plug_template_id=>wwv_flow_imp.id(8796832293851637)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8797785917851639)
,p_plug_template_id=>wwv_flow_imp.id(8796832293851637)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8798013281851639)
,p_plug_template_id=>wwv_flow_imp.id(8796832293851637)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8798304235851639)
,p_plug_template_id=>wwv_flow_imp.id(8796832293851637)
