...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8771925310851603)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8772292318851603)
,p_plug_template_id=>wwv_flow_imp.id(8771925310851603)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8772599762851603)
,p_plug_template_id=>wwv_flow_imp.id(8771925310851603)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8772876712851603)
,p_plug_template_id=>wwv_flow_imp.id(8771925310851603)
,p_name=>'Button Start'
